...
var cheerioHtmlFile = function(inType,htmlfile,checksfile) {
    var html = '';
    if (inType=='U') {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <html_url>', 'HTML URL') 
        .parse(process.argv);
    //checksfile=program.checks; 
    if (program.url != null) {
      cheerioHtmlFile('U',program.url,program.checks);
    } else {
      cheerioHtmlFile('F',program.file,program.checks);
    }
} else {
